...
void loop() {
  ...
  digitalWrite (transistorL, HIGH); //Turns on transistor left which is required for the left motor to move HEY WE SHOULD CHECK VOLTAGE SO SHIT DOESNT GET FRIED
